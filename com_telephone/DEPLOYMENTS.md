...
propre log. La PWA téléphone affiche un sélecteur de projet. Un déploiement « raccordé » ne copie
pas le serveur : il ajoute seulement un `ROBERTO/com_telephone/README.md`, une commande de
surveillance (`/roberto`), et une entrée dans `projects.json` du pont hôte. Voir
`Roberto/roadmap_com_telephone_hub.md` pour la migration et la commande d'init.
